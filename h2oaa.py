...
train = h2o.import_file("../deepLearning/fastai/datasets/dataset-er.csv")
test = h2o.import_file("../deepLearning/fastai/datasets/dataset-er.csv")
...
lb = aml.leaderboard
result = lb.head(rows=lb.nrows)  # Print all rows instead of default (10 rows)
print(result)
